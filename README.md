...
### **Vídeo de Demostración**
📹 **[Enlace al vídeo en YouTube](https://youtu.be/zXBMeHTnSXA)**
> Vídeo mostrando las principales funcionalidades de la aplicación web.
...
![Diagrama de Clases Actualizado](ProyectTicketFlow/src/main/resources/posts/diagramaTemRest.png)
...
| Nº    |                                                                                    Commits                                                                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Files                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:------------: |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|1|                              [Cambios para userDTO](https://github.com/DWS-2026/project-grupo-17/commit/6fad2b4fc2955fa48608ea28320e381c965eb653)                              | [UserController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/UserController.java) <br>[UserDTO.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/dto/UserDTO.java) <br>[Discoteca.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/model/Discoteca.java) <br>[SecurityConfig.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/security/SecurityConfig.java) <br>[DatabaseInitializer.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/DatabaseInitializer.java) <br>[DiscotecaService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/DiscotecaService.java) <br>[EntradaService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/EntradaService.java) <br>[EventoService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/EventoService.java) <br>[UserService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/UserService.java) <br>[admin.html](ProyectTicketFlow/src/main/resources/templates/admin.html) |
|2| [Errores en json para la API implementados y actualización de ApiSecurityConfig](https://github.com/DWS-2026/project-grupo-17/commit/39eed586f2154177e02732f23d3264b2baf8145c) |                                                                                                                                                                                                                                                                                                                                                                                               [GlobalExceptionHandler.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/GlobalExceptionHandler.java) <br> [ApiSecurityConfig.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/security/ApiSecurityConfig.java)                                                                                                                                                                                                                                                                                                                                                                                               |
|3|                                                      [Documentacion de api con openapi y colección postman](https://github.com/DWS-2026/project-grupo-17/commit/8cb669990b17dc8035ec7e80257bba6964c11eb9)                                                      |                                                                                                                                                                          [ProyectTicketFlow.postman_collection.json](ProyectTicketFlow/ProyectTicketFlow.postman_collection.json) <br> [.openapi-generator-ignore](ProyectTicketFlow/api-docs/.openapi-generator-ignore) <br> [FILES](ProyectTicketFlow/api-docs/.openapi-generator/FILES) <br> [VERSION](ProyectTicketFlow/api-docs/.openapi-generator/VERSION) <br> [api-docs.yaml-default.sha256](ProyectTicketFlow/api-docs/.openapi-generator/api-docs.yaml-default.sha256)   <br> [api-docs.yaml](ProyectTicketFlow/api-docs/api-docs.yaml)   <br> [index.html](ProyectTicketFlow/api-docs/index.html)   <br> [application.properties](ProyectTicketFlow/src/main/resources/application.properties)  <br> [keystore.jks](ProyectTicketFlow/src/main/resources/keystore.jks)                                                                                                                                                                          |
...
|2| [Implementación para guardar fichero en disco y recuperarlo](https://github.com/DWS-2026/project-grupo-17/commit/0a037eb0a45b49016e2553901aa1ce199177e987)  | [WebConfig.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/config/WebConfig.java) <br>[DiscotecaController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/DiscotecaController.java) <br>[DiscotecaRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/DiscotecaRestController.java) <br>[EventoController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/EventoController.java) <br>[FileRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/FileRestController.java) <br>[ImageController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/ImageController.java) <br>[Image.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/model/Image.java) <br>[DiscotecaService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/DiscotecaService.java) <br>[EventoService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/EventoService.java) <br>[FileStorageService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/FileStorageService.java) <br>[ImageService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/ImageService.java)  |
|3| [Guardar la imagen con UUID y nombre original](https://github.com/DWS-2026/project-grupo-17/commit/089c69b1a5e820ffd1cb4f3c29f069b1a8b0d35a)  | [FileStorage.service](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/FileStorageService.java)   |
|4| [Metodo post para poder editar la discoteca directamente en postman y poder subir desde ahi un pdf a disco](https://github.com/DWS-2026/project-grupo-17/commit/53549d8c676ea589062e4f6c2ba35562ca12f85b)  | [DiscotecaRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/DiscotecaRestController.java) <br>[DiscotecaService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/DiscotecaService.java)  |
...
|2| [Creacion de los DTOS y los rest controller para la API](https://github.com/DWS-2026/dws-2026-project-base/commit/d5dc784a3c5ec8ddb3b2f92e4d0c439d651ac612) | [DiscotecaDTO.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/dto/DiscotecaDTO.java) <br>[EntradaDTO.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/dto/EntradaDTO.java) <br>[EventoDTO.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/dto/EventoDTO.java) <br>[SignupRequestDTO.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/dto/SignupRequestDTO.java) <br>[UserDTO.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/dto/UserDTO.java) <br>[AuthRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/AuthRestController.java) <br>[DiscotecaRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/DiscotecaRestController.java) <br>[EntradaRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/EntradaRestController.java) <br>[EventoRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/EventoRestController.java) <br>[UserRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/UserRestController.java) |
|3| [Immplementacion de texto enriquecido con Quill.js en descripción de discotecas y eventos](https://github.com/DWS-2026/dws-2026-project-base/commit/45d3030b8a3642ee3db8c4db3f6f3a732cc6bb25) | [Discoteca.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/model/Discoteca.java) <br>[Evento.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/model/Evento.java) <br>[create-discotecas.html](ProyectTicketFlow/src/main/resources/templates/create-discotecas.html) <br>[create-event.html](ProyectTicketFlow/src/main/resources/templates/create-event.html) <br>[edit-discoteca.html](ProyectTicketFlow/src/main/resources/templates/edit-discoteca.html) <br>[edit-event.html](ProyectTicketFlow/src/main/resources/templates/edit-event.html) |
|4| [Cambios para evitar el xss y modificacion de la creacion del pdf](https://github.com/DWS-2026/dws-2026-project-base/commit/2ebe15d6dc16637b6757cd418e25181fe558aaca) | [Discoteca.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/model/Discoteca.java) <br>[Evento.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/model/Evento.java) <br>[DiscotecaService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/DiscotecaService.java) <br>[EntradaService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/EntradaService.java) |
|5| [Refactorización de API REST, validaciones de integridad y separación de seguridad](https://github.com/DWS-2026/dws-2026-project-base/commit/7bbeab4b293e49179538dced1082e8ae719db36e) | [ApiSecurityConfig.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/security/ApiSecurityConfig.java) <br>[WebSecurityConfig.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/security/WebSecurityConfig.java) <br>[DiscotecaService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/DiscotecaService.java) <br>[EventoService.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/service/EventoService.java) <br>[DiscotecaRestController.java](ProyectTicketFlow/src/main/java/es/codeurjc/board/controller/DiscotecaRestController.java) |
